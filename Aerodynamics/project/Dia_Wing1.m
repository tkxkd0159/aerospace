function [Cl, M2, M3, M4, M5] = Dia_Wing1(theta, M1, AOA, gamma, R)
%----- Section 2-----------------------------------------------------------
theta2 = theta-AOA;  
[beta2, Mn1_2] = oblique_relations(M1, theta2, gamma);
[ Mn2,p2_p1,rho2_rho1,T2_T1,p02_p01,p02_p1 ] = NSP( gamma,R,Mn1_2 );
