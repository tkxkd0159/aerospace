function [Cl, M2, M3, M4, M5] = Dia_Wing3(theta, M1, AOA, gamma, R)

%----- Section 2-----------------------------------------------------------
theta2 = AOA-theta ;
 [ M2,T2_T1,p2_p1 ] = prandtl_meyer(M1,gamma,theta2 );
...
Cl = (2/(gamma*(M1^2)))*(l_c)*((p4_p1-p3_p1)*cosd(theta+AOA)+(p5_p1-p2_p1)*cosd(AOA-theta));
end
